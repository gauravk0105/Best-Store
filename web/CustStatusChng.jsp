<%-- 
    Document   : CustStatusChng
    Created on : 13 Jul, 2017, 10:51:01 PM
    Author     : Dell
--%>
    ...
    %>
        ...
        <%
            try{
                ...
                List<CustomerManager> list = CustomerManager.getRecords("SELECT * FROM CustomerMaster ORDER BY cname");
        ...
        %>
                    ...
                    <!-- This IS Not Been Added Because This Is Not
                    <!--<th>Product ID</th>-->    
                    <td><%= list.get(i).getCcontact() %></td>
                    <td><%= list.get(i).getCstatus() %></td>
                       
                     <td>  
                        <form action="CustStatusProcess.jsp" method="post">
                            <input type="hidden" name="id" value="<%= list.get(i).getCid() %>"/>
