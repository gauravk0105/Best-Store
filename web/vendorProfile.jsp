<%-- 
    ...
    Created on : 7 Jul, 2017, 11:15:39 PM
    Author     : Dell
--%>
   ...
   %> 
	...
	<div class="mail animated wow zoomIn" data-wow-delay=".5s">
		<div class="container">
			...
			<p class="est">Functions Of Vendors</p>
<!---728x90--->
			<div class="mail-grids">
				<div class="col-md-8 mail-grid-left animated wow slideInLeft" data-wow-delay=".5s">
					<form action="addProduct.jsp" method="get">
						<input style="width:40%" type="submit" value="Add New Product" />
					</form>
                                    <br/>
                                        <form>
						<input style="width:40%" type="submit" value="Update Existing Product" />
					</form>
                                    <br/>
                                        <form>
						<input style="width:40%" type="submit" value="Delete Existing Product" />
					</form>
                                    <br/>
                                        <form method="get" action="ViewProductServlet.jsp">
						<input style="width:40%" type="submit" value="View Ordered Product List" />
					</form>
				</div>
  ...
  <div class="lol">
      <h4><b><% out.print(request.getAttribute("name")); %></b></h4> 
    <p>Vendor</p> 
  </div>
</div>
