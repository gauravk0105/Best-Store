<%-- 
    Document   : addBrand
    Created on : 13 Jul, 2017, 9:08:16 PM
    Author     : Dell
--%>
...
<body>
    ...
    %>
		...
		<div class="container">
			...
			<p class="est animated wow zoomIn" data-wow-delay=".5s">Add New Brand</p>
                        
                        <div class="login-form-grids">
			
<!---728x90--->
				<h6 class="animated wow slideInUp" data-wow-delay=".5s">Brand Information</h6>
				<form class="animated wow slideInUp" data-wow-delay=".5s" action="registerBrand.jsp" method="post">
					<input id="icon1" name="bname" type="text" placeholder="Brand Name..." required=" " >
                                        <br/>
					...
					<input type="submit" value="Add New">
                        ...
                        <h3 class="animated wow zoomIn" data-wow-delay=".5s">Brands List</h3>
			<p class="est animated wow zoomIn" data-wow-delay=".5s">View All Brand</p>
                        
                        <div class="login-form-grids">
			
<!---728x90--->
				<h6 class="animated wow slideInUp" data-wow-delay=".5s">Best Store Register Brands</h6>
				<table class="animated wow slideInUp" align="center" width="90%" data-wow-delay=".5s" border="1" >
                                        ...
                                        <tbody>
                                            <%
                                                try{
                                                List<BrandManager> list = BrandManager.getRecords("SELECT * FROM BrandMaster ORDER BY bid");
                                                if( list == null || list.size() == 0 )
                                                {
                                                   out.print("<td colspan='3' style='color:green'>NO Brands Register Yet</td>"); 
                                                }
                                                else{
